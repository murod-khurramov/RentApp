...
{{--                                                    <input name="search_phrase" type="text" id="job-keyword" class="form-input filter-input-box bg-gray-50 dark:bg-slate-800 border-0" placeholder="Search here">--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
...
{{--                                                    <input name="choices-min-price" type="number" id="choices-min-price-buy" class="form-input filter-input-box bg-gray-50 dark:bg-slate-800 border-0" placeholder="Min price">--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
...
{{--                                                    <i class="uil uil-usd-circle icons"></i>--}}
{{--                                                    <input name="choices-max-price" type="number" id="choices-max-price-buy" class="form-input filter-input-box bg-gray-50 dark:bg-slate-800 border-0" placeholder="Max price">--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
...
{{--                                                <div class="filter-search-form relative filter-border mt-2">--}}
{{--                                                    <i class="uil uil-usd-circle icons"></i>--}}
{{--                                                    <input name="choices-min-price" type="number" id="choices-min-price-rent" class="form-input filter-input-box bg-gray-50 dark:bg-slate-800 border-0" placeholder="Min price">--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
...
{{--                                                <div class="filter-search-form relative mt-2">--}}
{{--                                                    <i class="uil uil-usd-circle icons"></i>--}}
{{--                                                    <input name="choices-max-price" type="number" id="choices-max-price-rent" class="form-input filter-input-box bg-gray-50 dark:bg-slate-800 border-0" placeholder="Max price">--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
...
{{--                                    <p class="text-lg font-medium">{{ $ad->price }} <span class="text-xs font-normal text-slate-400">/Month</span></p>--}}
{{--                                </li>--}}
{{--                            </ul>--}}
{{--                        </div>--}}
{{--                    </div>--}}
